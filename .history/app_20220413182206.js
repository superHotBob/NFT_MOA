...
app.get("/api/addcontract", (req, res) => {
  res.send(
    `<div style="width: 30%;margin: 20vw auto">
    <form>
    <label>
    <input type='text' placeholder='smartcontract name' style="width: 100%;margin: 30px auto"/>
    </label>
    <label>
    <input type='text' placeholder='collection name' style="padding: 20;width: 100%;margin: 30px auto"/>
    </label>
    <button type='submit' style="padding: 20;width: 100%;margin: 30px auto">add collection </button>
    </form>
    </div>`
  );
});
