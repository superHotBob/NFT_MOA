...
app.get("/api/addnewcontract", db.addCollection, (req, res) => {
  ...
  res.send(
    ...
    <input type="radio" id="create" checked style="width:30px;height: 30px"
     name="doing" value="create">
    <label for="create">Create collection</label>

    <input type="radio" id="update" style="width:30px;height: 30px"
     name="doing" value="phone">
    <label for="contactChoice2">Update collection</label>

    <input type="radio" id="delete" style="width:30px;height: 30px"
