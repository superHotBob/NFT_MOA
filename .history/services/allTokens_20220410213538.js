...
//   console.log(response.data.nfts);
  ...
  function writeToBase() {
    if (m > -1) {
      const tokenId = response.data.nfts[m].id.tokenId;
      const config = {
        method: "get",
      ...
      axios(config)
        ...
        //   pool.query(
        //     "INSERT INTO tokens (address,tokenid,token_name,image,meta_info,id) VALUES ($1, $2, $3, $4, $5, $6)",
        //     [a[n - 1].address, b, c, d, e,f],
        //     (error, results) => {
        //       if (error) {
        //         throw error;
        //       }
