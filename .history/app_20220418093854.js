...
app.get("/api/addnewcontract", db.addCollection, (req, res) => {
  ...
  res.send(
    ...
    <legend>Please select your preferred collection method:</legend>
    <input type="radio" id="create" checked 
    style="width:30px;height: 30px; vertical-align: sub;width: 30%"
    ...
    <label for="contactChoice2">Update </label>
